...
import com.example.e_commerce_app.Helper.ChangeNumberItemsListener
import com.example.e_commerce_app.Helper.TinyDB
...
class ManagmentCart(val context: Context) {
    ...
    fun insert(model: com.example.e_commerce_app.model.ItemModel) {}
}

private fun ChangeNumberItemsListener.onChanged() {
